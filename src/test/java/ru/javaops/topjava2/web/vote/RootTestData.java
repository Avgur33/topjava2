...
public class RootTestData extends AbstractTestData {
    ...
    public static final MatcherFactory.Matcher<Vote> MATCHERVOTE = MatcherFactory.usingIgnoringFieldsComparator(Vote.class, "restaurant", "user");

    public static final RestaurantTo restTo1 = RestaurantUtil.createTo(rest1,1);
    public static final RestaurantTo restTo2 = RestaurantUtil.createTo(rest2,1);
