...
public class DishTestData extends AbstractTestData {
    ...
    public static final Dish dish1 = new Dish(DISH1_ID + 0, "burger 1", 100, LocalDate.now().minusDays(1L));
    public static final Dish dish2 = new Dish(DISH1_ID + 1, "burger 2", 200, LocalDate.now().minusDays(1L));
    public static final Dish dish3 = new Dish(DISH1_ID + 2, "burger 3", 300, LocalDate.now().minusDays(1L));
    public static final Dish dish4 = new Dish(DISH1_ID + 3, "pho bo 1", 400, LocalDate.now().minusDays(1L));
    public static final Dish dish5 = new Dish(DISH1_ID + 4, "pho bo 2", 500, LocalDate.now().minusDays(1L));
    public static final Dish dish6 = new Dish(DISH1_ID + 5, "pho bo 3", 600, LocalDate.now().minusDays(1L));
    public static final Dish dish7 = new Dish(DISH1_ID + 6, "chicken 1", 700, LocalDate.now().minusDays(1L));
    public static final Dish dish8 = new Dish(DISH1_ID + 7, "chicken 2", 800, LocalDate.now().minusDays(1L));
    public static final Dish dish9 = new Dish(DISH1_ID + 8, "chicken 3", 900, LocalDate.now().minusDays(1L));
    ...
    public static Dish getUpdated(){return new Dish(DISH10_ID, "Updated Dish", 1000, LocalDate.now());}
}
